...
- **Superseded in part by:** ADR 0007 for manifest v7 and typed parameters; ADR 0008 places parameter dimensions before seeds; ADR 0009 defines the current snapshot, browser, and SQLite baselines.
